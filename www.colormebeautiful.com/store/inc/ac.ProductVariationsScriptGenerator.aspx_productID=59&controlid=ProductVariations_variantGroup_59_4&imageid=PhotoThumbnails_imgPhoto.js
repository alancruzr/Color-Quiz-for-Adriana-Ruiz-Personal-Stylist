...
VariantSwatchesProductVariations_variantGroup_59_4 = {
SwatchArray: { 102: {
                        SwatchURL: '/Shared/images/Product/Extreme Sheen Lipgloss Swatches/dune_434024-lr.jpg',
                        ControlPath: 'ProductVariations_variantGroup_59_4'
                    }, 103: {
                        SwatchURL: '/Shared/images/Product/Extreme Sheen Lipgloss Swatches/434031_Pink-Shell-lr.jpg',
                        ControlPath: 'ProductVariations_variantGroup_59_4'
                    } },
  ImagingMode: "Resizer",
  ...
  SelectVariant: function(groupID, variantID, setDropDown) {
    ...
    var o = VariantSwatchesProductVariations_variantGroup_59_4.SwatchArray[variantID];
    if (o) {
      if (setDropDown)
...
$(function(){
	...
	$("select[id$='ProductVariations_variantGroup_59_4']").change(function() { VariantSwatchesProductVariations_variantGroup_59_4.SelectVariant( $(this).parent().find("input[type=hidden]").val() , $(this).val(), false) });

    // Bind radio button selection event
    $("input[type=radio][name$='ProductVariations_variantGroup_59_4']").change(function() {
        VariantSwatchesProductVariations_variantGroup_59_4.SelectVariant( $(this).closest('.ProductDetailsVariations').find('.ProductDetailsVariations').find("input[type=hidden]").val() , $(this).val(), false);
    });
})
