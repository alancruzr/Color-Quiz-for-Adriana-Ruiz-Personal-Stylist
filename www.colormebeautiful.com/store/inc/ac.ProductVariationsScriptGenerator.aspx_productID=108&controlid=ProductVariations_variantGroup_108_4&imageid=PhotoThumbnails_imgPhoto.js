...
VariantSwatchesProductVariations_variantGroup_108_4 = {
SwatchArray: { 242: {
                        SwatchURL: '/Shared/images/Product/Nail Lacquer Swatches/462188_DuoAct.jpg',
                        ControlPath: 'ProductVariations_variantGroup_108_4'
                    }, 239: {
                        SwatchURL: '/Shared/images/Product/Nail Lacquer Swatches/462140_nudeScene.jpg',
                        ControlPath: 'ProductVariations_variantGroup_108_4'
                    }, 235: {
                        SwatchURL: '/Shared/images/Product/Nail Lacquer Swatches/462126_EverAfter.jpg',
                        ControlPath: 'ProductVariations_variantGroup_108_4'
                    }, 238: {
                        SwatchURL: '/Shared/images/Product/Nail Lacquer Swatches/462119_MainSqueeze.jpg',
                        ControlPath: 'ProductVariations_variantGroup_108_4'
                    }, 240: {
                        SwatchURL: '/Shared/images/Product/Nail Lacquer Swatches/462171_smokinHot.jpg',
                        ControlPath: 'ProductVariations_variantGroup_108_4'
                    }, 236: {
                        SwatchURL: '/Shared/images/Product/Nail Lacquer Swatches/462218_FeelinHot.jpg',
                        ControlPath: 'ProductVariations_variantGroup_108_4'
                    }, 237: {
                        SwatchURL: '/Shared/images/Product/Nail Lacquer Swatches/462225_KissMyHibiscus.jpg',
                        ControlPath: 'ProductVariations_variantGroup_108_4'
                    }, 234: {
                        SwatchURL: '/Shared/images/Product/Nail Lacquer Swatches/462157_DropDeadRed.jpg',
                        ControlPath: 'ProductVariations_variantGroup_108_4'
                    }, 233: {
                        SwatchURL: 'https://www.colormebeautiful.com/resize/images/462164_afterHours.jpg?bw=800&w=800&bh=800&h=800',
                        ControlPath: 'ProductVariations_variantGroup_108_4'
                    }, 241: {
                        SwatchURL: '/Shared/images/Product/Nail-Lacquer/462133_Stiletto.jpg',
                        ControlPath: 'ProductVariations_variantGroup_108_4'
                    } },
  ImagingMode: "Resizer",
  ...
  SelectVariant: function(groupID, variantID, setDropDown) {
    ...
    var o = VariantSwatchesProductVariations_variantGroup_108_4.SwatchArray[variantID];
    if (o) {
      if (setDropDown)
...
$(function(){
	...
	$("select[id$='ProductVariations_variantGroup_108_4']").change(function() { VariantSwatchesProductVariations_variantGroup_108_4.SelectVariant( $(this).parent().find("input[type=hidden]").val() , $(this).val(), false) });

    // Bind radio button selection event
    $("input[type=radio][name$='ProductVariations_variantGroup_108_4']").change(function() {
        VariantSwatchesProductVariations_variantGroup_108_4.SelectVariant( $(this).closest('.ProductDetailsVariations').find('.ProductDetailsVariations').find("input[type=hidden]").val() , $(this).val(), false);
    });
})
