...
VariantSwatchesProductVariations_variantGroup_63_4 = {
SwatchArray: { 112: {
                        SwatchURL: '/Shared/images/Product/Camoflauge Concealer/lightneutral_422106.jpg',
                        ControlPath: 'ProductVariations_variantGroup_63_4'
                    }, 113: {
                        SwatchURL: '/Shared/images/Product/Camoflauge Concealer/medium_422083.jpg',
                        ControlPath: 'ProductVariations_variantGroup_63_4'
                    }, 111: {
                        SwatchURL: '/Shared/images/Product/Camoflauge Concealer/amber_422090.jpg',
                        ControlPath: 'ProductVariations_variantGroup_63_4'
                    }, 114: {
                        SwatchURL: '/Shared/images/Product/Camoflauge Concealer/dark_422113.jpg',
                        ControlPath: 'ProductVariations_variantGroup_63_4'
                    } },
  ImagingMode: "Resizer",
  ...
  SelectVariant: function(groupID, variantID, setDropDown) {
    ...
    var o = VariantSwatchesProductVariations_variantGroup_63_4.SwatchArray[variantID];
    if (o) {
      if (setDropDown)
...
$(function(){
	...
	$("select[id$='ProductVariations_variantGroup_63_4']").change(function() { VariantSwatchesProductVariations_variantGroup_63_4.SelectVariant( $(this).parent().find("input[type=hidden]").val() , $(this).val(), false) });

    // Bind radio button selection event
    $("input[type=radio][name$='ProductVariations_variantGroup_63_4']").change(function() {
        VariantSwatchesProductVariations_variantGroup_63_4.SelectVariant( $(this).closest('.ProductDetailsVariations').find('.ProductDetailsVariations').find("input[type=hidden]").val() , $(this).val(), false);
    });
})
