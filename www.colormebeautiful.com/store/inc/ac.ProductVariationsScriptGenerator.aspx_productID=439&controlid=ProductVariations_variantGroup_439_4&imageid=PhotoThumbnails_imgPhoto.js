...
VariantSwatchesProductVariations_variantGroup_439_4 = {
SwatchArray: { 596: {
                        SwatchURL: '/Shared/images/Product/Throwin-Shade-Single-Eyeshadows/Glo-Up.jpg',
                        ControlPath: 'ProductVariations_variantGroup_439_4'
                    }, 597: {
                        SwatchURL: '/Shared/images/Product/Throwin-Shade-Single-Eyeshadows/Money-Maker.jpg',
                        ControlPath: 'ProductVariations_variantGroup_439_4'
                    }, 598: {
                        SwatchURL: '/Shared/images/Product/Throwin-Shade-Single-Eyeshadows/Run-The-World.jpg',
                        ControlPath: 'ProductVariations_variantGroup_439_4'
                    }, 594: {
                        SwatchURL: '/Shared/images/Product/Throwin-Shade-Single-Eyeshadows/Sorry-Not-Sorry.jpg',
                        ControlPath: 'ProductVariations_variantGroup_439_4'
                    }, 595: {
                        SwatchURL: '/Shared/images/Product/Throwin-Shade-Single-Eyeshadows/Werk-It.jpg',
                        ControlPath: 'ProductVariations_variantGroup_439_4'
                    } },
  ImagingMode: "Resizer",
  ...
  SelectVariant: function(groupID, variantID, setDropDown) {
    ...
    var o = VariantSwatchesProductVariations_variantGroup_439_4.SwatchArray[variantID];
    if (o) {
      if (setDropDown)
...
$(function(){
	...
	$("select[id$='ProductVariations_variantGroup_439_4']").change(function() { VariantSwatchesProductVariations_variantGroup_439_4.SelectVariant( $(this).parent().find("input[type=hidden]").val() , $(this).val(), false) });

    // Bind radio button selection event
    $("input[type=radio][name$='ProductVariations_variantGroup_439_4']").change(function() {
        VariantSwatchesProductVariations_variantGroup_439_4.SelectVariant( $(this).closest('.ProductDetailsVariations').find('.ProductDetailsVariations').find("input[type=hidden]").val() , $(this).val(), false);
    });
})
