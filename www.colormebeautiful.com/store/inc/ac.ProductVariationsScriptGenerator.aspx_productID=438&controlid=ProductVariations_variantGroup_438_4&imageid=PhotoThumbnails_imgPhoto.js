...
VariantSwatchesProductVariations_variantGroup_438_4 = {
SwatchArray: { 593: {
                        SwatchURL: '/Shared/images/Product/Color Pro Eyeshadow Swatches/RoseQSwatch.jpg',
                        ControlPath: 'ProductVariations_variantGroup_438_4'
                    }, 584: {
                        SwatchURL: '/Shared/images/Product/Color Pro Eyeshadow Swatches/BalletPinkSw.jpg',
                        ControlPath: 'ProductVariations_variantGroup_438_4'
                    }, 587: {
                        SwatchURL: '/Shared/images/Product/Color Pro Eyeshadow Swatches/CottonCandySw.jpg',
                        ControlPath: 'ProductVariations_variantGroup_438_4'
                    }, 589: {
                        SwatchURL: '/Shared/images/Product/Color Pro Eyeshadow Swatches/Peach-Tart-Swatch.jpg',
                        ControlPath: 'ProductVariations_variantGroup_438_4'
                    }, 592: {
                        SwatchURL: '/Shared/images/Product/Color Pro Eyeshadow Swatches/Silvered-Lilac-Swatch-1.jpg',
                        ControlPath: 'ProductVariations_variantGroup_438_4'
                    }, 586: {
                        SwatchURL: '/Shared/images/Product/Color Pro Eyeshadow Swatches/BananaCreamSw.jpg',
                        ControlPath: 'ProductVariations_variantGroup_438_4'
                    }, 585: {
                        SwatchURL: '/Shared/images/Product/Color Pro Eyeshadow Swatches/Zeal-Teal-Swatch.jpg',
                        ControlPath: 'ProductVariations_variantGroup_438_4'
                    }, 588: {
                        SwatchURL: '/Shared/images/Product/Color Pro Eyeshadow Swatches/Malted-Milk-Swatch.jpg',
                        ControlPath: 'ProductVariations_variantGroup_438_4'
                    }, 591: {
                        SwatchURL: '/Shared/images/Product/Color Pro Eyeshadow Swatches/Polished-Pewter-Swatch.jpg',
                        ControlPath: 'ProductVariations_variantGroup_438_4'
                    }, 590: {
                        SwatchURL: '/Shared/images/Product/Color Pro Eyeshadow Swatches/Tuscany-Palm-Swatch.jpg',
                        ControlPath: 'ProductVariations_variantGroup_438_4'
                    } },
  ImagingMode: "Resizer",
  ...
  SelectVariant: function(groupID, variantID, setDropDown) {
    ...
    var o = VariantSwatchesProductVariations_variantGroup_438_4.SwatchArray[variantID];
    if (o) {
      if (setDropDown)
...
$(function(){
	...
	$("select[id$='ProductVariations_variantGroup_438_4']").change(function() { VariantSwatchesProductVariations_variantGroup_438_4.SelectVariant( $(this).parent().find("input[type=hidden]").val() , $(this).val(), false) });

    // Bind radio button selection event
    $("input[type=radio][name$='ProductVariations_variantGroup_438_4']").change(function() {
        VariantSwatchesProductVariations_variantGroup_438_4.SelectVariant( $(this).closest('.ProductDetailsVariations').find('.ProductDetailsVariations').find("input[type=hidden]").val() , $(this).val(), false);
    });
})
