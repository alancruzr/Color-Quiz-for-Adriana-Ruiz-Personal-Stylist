...
VariantSwatchesProductVariations_variantGroup_74_4 = {
SwatchArray: { 115: {
                        SwatchURL: '/Shared/images/Product/Perfection Pressed Powder Swatches/243940_whisperBeige.jpg',
                        ControlPath: 'ProductVariations_variantGroup_74_4'
                    }, 118: {
                        SwatchURL: '/Shared/images/Product/Perfection Pressed Powder Swatches/Creamy-cameo.psd.png',
                        ControlPath: 'ProductVariations_variantGroup_74_4'
                    }, 116: {
                        SwatchURL: '/Shared/images/Product/Perfection Pressed Powder Swatches/SEPIA-BEIGE-PRESSED-POWDER.jpg',
                        ControlPath: 'ProductVariations_variantGroup_74_4'
                    }, 117: {
                        SwatchURL: '/Shared/images/Product/Perfection Pressed Powder Swatches/Almond.psd.png',
                        ControlPath: 'ProductVariations_variantGroup_74_4'
                    } },
  ImagingMode: "Resizer",
  ...
  SelectVariant: function(groupID, variantID, setDropDown) {
    ...
    var o = VariantSwatchesProductVariations_variantGroup_74_4.SwatchArray[variantID];
    if (o) {
      if (setDropDown)
...
$(function(){
	...
	$("select[id$='ProductVariations_variantGroup_74_4']").change(function() { VariantSwatchesProductVariations_variantGroup_74_4.SelectVariant( $(this).parent().find("input[type=hidden]").val() , $(this).val(), false) });

    // Bind radio button selection event
    $("input[type=radio][name$='ProductVariations_variantGroup_74_4']").change(function() {
        VariantSwatchesProductVariations_variantGroup_74_4.SelectVariant( $(this).closest('.ProductDetailsVariations').find('.ProductDetailsVariations').find("input[type=hidden]").val() , $(this).val(), false);
    });
})
