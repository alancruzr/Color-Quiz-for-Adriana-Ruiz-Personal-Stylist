...
VariantSwatchesProductVariations_variantGroup_57_4 = {
SwatchArray: { 91: {
                        SwatchURL: '/Shared/images/Product/Luxury Lip Pencil Swatches/intense-berry-swatch1.jpg',
                        ControlPath: 'ProductVariations_variantGroup_57_4'
                    }, 92: {
                        SwatchURL: '/Shared/images/Product/Luxury Lip Pencil Swatches/chestnut-swatch1.jpg',
                        ControlPath: 'ProductVariations_variantGroup_57_4'
                    } },
  ImagingMode: "Resizer",
  ...
  SelectVariant: function(groupID, variantID, setDropDown) {
    ...
    var o = VariantSwatchesProductVariations_variantGroup_57_4.SwatchArray[variantID];
    if (o) {
      if (setDropDown)
...
$(function(){
	...
	$("select[id$='ProductVariations_variantGroup_57_4']").change(function() { VariantSwatchesProductVariations_variantGroup_57_4.SelectVariant( $(this).parent().find("input[type=hidden]").val() , $(this).val(), false) });

    // Bind radio button selection event
    $("input[type=radio][name$='ProductVariations_variantGroup_57_4']").change(function() {
        VariantSwatchesProductVariations_variantGroup_57_4.SelectVariant( $(this).closest('.ProductDetailsVariations').find('.ProductDetailsVariations').find("input[type=hidden]").val() , $(this).val(), false);
    });
})
