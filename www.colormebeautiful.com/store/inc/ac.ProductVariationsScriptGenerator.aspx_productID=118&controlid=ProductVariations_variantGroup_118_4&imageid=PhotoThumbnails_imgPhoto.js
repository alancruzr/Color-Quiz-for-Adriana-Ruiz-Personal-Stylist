...
VariantSwatchesProductVariations_variantGroup_118_4 = {
SwatchArray: { 282: {
                        SwatchURL: '/Shared/images/Product/Mineral-Lip-Shine/Screen-Shot-2017-04-03-at-10.53.27-AM.png',
                        ControlPath: 'ProductVariations_variantGroup_118_4'
                    }, 284: {
                        SwatchURL: '/Shared/images/Product/Mineral-Lip-Shine/unspecified-9.jpeg',
                        ControlPath: 'ProductVariations_variantGroup_118_4'
                    }, 286: {
                        SwatchURL: '/Shared/images/Product/Mineral-Lip-Shine/unspecified-2.png',
                        ControlPath: 'ProductVariations_variantGroup_118_4'
                    }, 329: {
                        SwatchURL: '/Shared/images/Product/Mineral-Lip-Shine/unspecified-10.jpeg',
                        ControlPath: 'ProductVariations_variantGroup_118_4'
                    } },
  ImagingMode: "Resizer",
  ...
  SelectVariant: function(groupID, variantID, setDropDown) {
    ...
    var o = VariantSwatchesProductVariations_variantGroup_118_4.SwatchArray[variantID];
    if (o) {
      if (setDropDown)
...
$(function(){
	...
	$("select[id$='ProductVariations_variantGroup_118_4']").change(function() { VariantSwatchesProductVariations_variantGroup_118_4.SelectVariant( $(this).parent().find("input[type=hidden]").val() , $(this).val(), false) });

    // Bind radio button selection event
    $("input[type=radio][name$='ProductVariations_variantGroup_118_4']").change(function() {
        VariantSwatchesProductVariations_variantGroup_118_4.SelectVariant( $(this).closest('.ProductDetailsVariations').find('.ProductDetailsVariations').find("input[type=hidden]").val() , $(this).val(), false);
    });
})
