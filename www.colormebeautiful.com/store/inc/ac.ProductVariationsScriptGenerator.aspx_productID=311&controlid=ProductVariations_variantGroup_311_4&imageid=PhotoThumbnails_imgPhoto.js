...
VariantSwatchesProductVariations_variantGroup_311_4 = {
SwatchArray: { 413: {
                        SwatchURL: '/Shared/images/Product/Color Pro Powder Blush Swatches/papaya-punch.jpg-1.jpg',
                        ControlPath: 'ProductVariations_variantGroup_311_4'
                    }, 415: {
                        SwatchURL: '/Shared/images/Product/Color Pro Powder Blush Swatches/fine-wine.jpg.jpg',
                        ControlPath: 'ProductVariations_variantGroup_311_4'
                    }, 414: {
                        SwatchURL: '/Shared/images/Product/Color Pro Powder Blush Swatches/cinammon-brandy.jpg.jpg',
                        ControlPath: 'ProductVariations_variantGroup_311_4'
                    } },
  ImagingMode: "Resizer",
  ...
  SelectVariant: function(groupID, variantID, setDropDown) {
    ...
    var o = VariantSwatchesProductVariations_variantGroup_311_4.SwatchArray[variantID];
    if (o) {
      if (setDropDown)
...
$(function(){
	...
	$("select[id$='ProductVariations_variantGroup_311_4']").change(function() { VariantSwatchesProductVariations_variantGroup_311_4.SelectVariant( $(this).parent().find("input[type=hidden]").val() , $(this).val(), false) });

    // Bind radio button selection event
    $("input[type=radio][name$='ProductVariations_variantGroup_311_4']").change(function() {
        VariantSwatchesProductVariations_variantGroup_311_4.SelectVariant( $(this).closest('.ProductDetailsVariations').find('.ProductDetailsVariations').find("input[type=hidden]").val() , $(this).val(), false);
    });
})
