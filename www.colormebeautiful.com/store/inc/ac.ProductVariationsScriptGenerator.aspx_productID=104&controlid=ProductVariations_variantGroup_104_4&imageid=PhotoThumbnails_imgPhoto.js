...
VariantSwatchesProductVariations_variantGroup_104_4 = {
SwatchArray: { 204: {
                        SwatchURL: '/Shared/images/Product/Brush On Brow Powder Swatchs/blonde.jpg',
                        ControlPath: 'ProductVariations_variantGroup_104_4'
                    }, 206: {
                        SwatchURL: '/Shared/images/Product/Brush On Brow Powder Swatchs/haze.jpg',
                        ControlPath: 'ProductVariations_variantGroup_104_4'
                    }, 203: {
                        SwatchURL: '/Shared/images/Product/Brush On Brow Powder Swatchs/auburn.jpg',
                        ControlPath: 'ProductVariations_variantGroup_104_4'
                    }, 205: {
                        SwatchURL: '/Shared/images/Product/Brush On Brow Powder Swatchs/brunette.jpg',
                        ControlPath: 'ProductVariations_variantGroup_104_4'
                    } },
  ImagingMode: "Resizer",
  ...
  SelectVariant: function(groupID, variantID, setDropDown) {
    ...
    var o = VariantSwatchesProductVariations_variantGroup_104_4.SwatchArray[variantID];
    if (o) {
      if (setDropDown)
...
$(function(){
	...
	$("select[id$='ProductVariations_variantGroup_104_4']").change(function() { VariantSwatchesProductVariations_variantGroup_104_4.SelectVariant( $(this).parent().find("input[type=hidden]").val() , $(this).val(), false) });

    // Bind radio button selection event
    $("input[type=radio][name$='ProductVariations_variantGroup_104_4']").change(function() {
        VariantSwatchesProductVariations_variantGroup_104_4.SelectVariant( $(this).closest('.ProductDetailsVariations').find('.ProductDetailsVariations').find("input[type=hidden]").val() , $(this).val(), false);
    });
})
