...
VariantSwatchesProductVariations_variantGroup_116_4 = {
SwatchArray: { 273: {
                        SwatchURL: '/Shared/images/Product/CreamyLipColor/calicoral.jpg',
                        ControlPath: 'ProductVariations_variantGroup_116_4'
                    }, 275: {
                        SwatchURL: '/Shared/images/Product/CreamyLipColor/Flamingo.jpg',
                        ControlPath: 'ProductVariations_variantGroup_116_4'
                    } },
  ImagingMode: "Resizer",
  ...
  SelectVariant: function(groupID, variantID, setDropDown) {
    ...
    var o = VariantSwatchesProductVariations_variantGroup_116_4.SwatchArray[variantID];
    if (o) {
      if (setDropDown)
...
$(function(){
	...
	$("select[id$='ProductVariations_variantGroup_116_4']").change(function() { VariantSwatchesProductVariations_variantGroup_116_4.SelectVariant( $(this).parent().find("input[type=hidden]").val() , $(this).val(), false) });

    // Bind radio button selection event
    $("input[type=radio][name$='ProductVariations_variantGroup_116_4']").change(function() {
        VariantSwatchesProductVariations_variantGroup_116_4.SelectVariant( $(this).closest('.ProductDetailsVariations').find('.ProductDetailsVariations').find("input[type=hidden]").val() , $(this).val(), false);
    });
})
