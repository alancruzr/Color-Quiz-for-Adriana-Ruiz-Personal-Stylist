...
VariantSwatchesProductVariations_variantGroup_33_4 = {
SwatchArray: { 48: {
                        SwatchURL: '/images/apple-blossom.jpg',
                        ControlPath: 'ProductVariations_variantGroup_33_4'
                    }, 416: {
                        SwatchURL: '/images/blazeweb.jpg',
                        ControlPath: 'ProductVariations_variantGroup_33_4'
                    }, 50: {
                        SwatchURL: '/images/brown-sugar.jpg',
                        ControlPath: 'ProductVariations_variantGroup_33_4'
                    }, 417: {
                        SwatchURL: '/images/chili.jpg',
                        ControlPath: 'ProductVariations_variantGroup_33_4'
                    }, 57: {
                        SwatchURL: '/images/cinnamon.jpg',
                        ControlPath: 'ProductVariations_variantGroup_33_4'
                    }, 59: {
                        SwatchURL: '/Shared/images/Product/Color Renew Lipstick Swatches/dusty-rose.jpg',
                        ControlPath: 'ProductVariations_variantGroup_33_4'
                    }, 37: {
                        SwatchURL: '/images/frosted-watermelon.jpg',
                        ControlPath: 'ProductVariations_variantGroup_33_4'
                    }, 60: {
                        SwatchURL: '/images/glam.jpg',
                        ControlPath: 'ProductVariations_variantGroup_33_4'
                    }, 68: {
                        SwatchURL: '/Shared/images/Product/Color Renew Lipstick Swatches/joy.jpg',
                        ControlPath: 'ProductVariations_variantGroup_33_4'
                    }, 70: {
                        SwatchURL: '/Shared/images/Product/Color Renew Lipstick Swatches/just-kissed-swatch.jpg',
                        ControlPath: 'ProductVariations_variantGroup_33_4'
                    }, 21: {
                        SwatchURL: '/Shared/images/Product/Color Renew Lipstick Swatches/mago-punch-swatch.jpg',
                        ControlPath: 'ProductVariations_variantGroup_33_4'
                    }, 418: {
                        SwatchURL: '/Shared/images/Product/Color Renew Lipstick Swatches/mocha-latte.jpg',
                        ControlPath: 'ProductVariations_variantGroup_33_4'
                    }, 72: {
                        SwatchURL: '/Shared/images/Product/Color Renew Lipstick Swatches/perfect-plum.jpg',
                        ControlPath: 'ProductVariations_variantGroup_33_4'
                    }, 73: {
                        SwatchURL: '/Shared/images/Product/Color Renew Lipstick Swatches/playful.jpg',
                        ControlPath: 'ProductVariations_variantGroup_33_4'
                    }, 94: {
                        SwatchURL: '/images/plum-sherbet-disc.jpg',
                        ControlPath: 'ProductVariations_variantGroup_33_4'
                    }, 666: {
                        SwatchURL: '/Shared/images/Product/Color Renew Lipstick Swatches/plum-sorbet.jpg',
                        ControlPath: 'ProductVariations_variantGroup_33_4'
                    }, 77: {
                        SwatchURL: '/Shared/images/Product/Color Renew Lipstick Swatches/plumberry.jpg',
                        ControlPath: 'ProductVariations_variantGroup_33_4'
                    }, 28: {
                        SwatchURL: '/Shared/images/Product/Color Renew Lipstick Swatches/red-carpet.jpg',
                        ControlPath: 'ProductVariations_variantGroup_33_4'
                    }, 97: {
                        SwatchURL: '/images/soft-plum.jpg',
                        ControlPath: 'ProductVariations_variantGroup_33_4'
                    }, 98: {
                        SwatchURL: '/images/SpiceSwatch.jpg',
                        ControlPath: 'ProductVariations_variantGroup_33_4'
                    }, 105: {
                        SwatchURL: '/Shared/images/Product/Color Renew Lipstick Swatches/sueded-rose-swatch.jpg',
                        ControlPath: 'ProductVariations_variantGroup_33_4'
                    } },
  ImagingMode: "Resizer",
  ...
  SelectVariant: function(groupID, variantID, setDropDown) {
    ...
    var o = VariantSwatchesProductVariations_variantGroup_33_4.SwatchArray[variantID];
    if (o) {
      if (setDropDown)
...
$(function(){
	...
	$("select[id$='ProductVariations_variantGroup_33_4']").change(function() { VariantSwatchesProductVariations_variantGroup_33_4.SelectVariant( $(this).parent().find("input[type=hidden]").val() , $(this).val(), false) });

    // Bind radio button selection event
    $("input[type=radio][name$='ProductVariations_variantGroup_33_4']").change(function() {
        VariantSwatchesProductVariations_variantGroup_33_4.SelectVariant( $(this).closest('.ProductDetailsVariations').find('.ProductDetailsVariations').find("input[type=hidden]").val() , $(this).val(), false);
    });
})
