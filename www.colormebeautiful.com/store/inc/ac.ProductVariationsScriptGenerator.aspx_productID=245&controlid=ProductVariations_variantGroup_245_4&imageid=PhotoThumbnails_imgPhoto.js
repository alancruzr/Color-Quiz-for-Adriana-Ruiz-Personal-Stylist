...
VariantSwatchesProductVariations_variantGroup_245_4 = {
SwatchArray: { 446: {
                        SwatchURL: '/Shared/images/Product/Nail-Lacquer-Collections/nail-lacquer-cool.jpg',
                        ControlPath: 'ProductVariations_variantGroup_245_4'
                    }, 447: {
                        SwatchURL: '/Shared/images/Product/Nail-Lacquer-Collections/nail-lacquer-warm.jpg',
                        ControlPath: 'ProductVariations_variantGroup_245_4'
                    } },
  ImagingMode: "Resizer",
  ...
  SelectVariant: function(groupID, variantID, setDropDown) {
    ...
    var o = VariantSwatchesProductVariations_variantGroup_245_4.SwatchArray[variantID];
    if (o) {
      if (setDropDown)
...
$(function(){
	...
	$("select[id$='ProductVariations_variantGroup_245_4']").change(function() { VariantSwatchesProductVariations_variantGroup_245_4.SelectVariant( $(this).parent().find("input[type=hidden]").val() , $(this).val(), false) });

    // Bind radio button selection event
    $("input[type=radio][name$='ProductVariations_variantGroup_245_4']").change(function() {
        VariantSwatchesProductVariations_variantGroup_245_4.SelectVariant( $(this).closest('.ProductDetailsVariations').find('.ProductDetailsVariations').find("input[type=hidden]").val() , $(this).val(), false);
    });
})
