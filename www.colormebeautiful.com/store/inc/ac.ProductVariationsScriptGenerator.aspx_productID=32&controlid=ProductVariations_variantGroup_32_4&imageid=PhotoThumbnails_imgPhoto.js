...
VariantSwatchesProductVariations_variantGroup_32_4 = {
SwatchArray: { 14: {
                        SwatchURL: '/Shared/images/Product/Radiance Blush Swatches/copacabanaswatch.jpg',
                        ControlPath: 'ProductVariations_variantGroup_32_4'
                    }, 15: {
                        SwatchURL: '/Shared/images/Product/Radiance Blush Swatches/darkswatch.jpg',
                        ControlPath: 'ProductVariations_variantGroup_32_4'
                    }, 16: {
                        SwatchURL: '/Shared/images/Product/Radiance Blush Swatches/rio.jpg',
                        ControlPath: 'ProductVariations_variantGroup_32_4'
                    }, 19: {
                        SwatchURL: '/Shared/images/Product/Radiance Blush Swatches/sableswatchR.jpg',
                        ControlPath: 'ProductVariations_variantGroup_32_4'
                    } },
  ImagingMode: "Resizer",
  ...
  SelectVariant: function(groupID, variantID, setDropDown) {
    ...
    var o = VariantSwatchesProductVariations_variantGroup_32_4.SwatchArray[variantID];
    if (o) {
      if (setDropDown)
...
$(function(){
	...
	$("select[id$='ProductVariations_variantGroup_32_4']").change(function() { VariantSwatchesProductVariations_variantGroup_32_4.SelectVariant( $(this).parent().find("input[type=hidden]").val() , $(this).val(), false) });

    // Bind radio button selection event
    $("input[type=radio][name$='ProductVariations_variantGroup_32_4']").change(function() {
        VariantSwatchesProductVariations_variantGroup_32_4.SelectVariant( $(this).closest('.ProductDetailsVariations').find('.ProductDetailsVariations').find("input[type=hidden]").val() , $(this).val(), false);
    });
})
