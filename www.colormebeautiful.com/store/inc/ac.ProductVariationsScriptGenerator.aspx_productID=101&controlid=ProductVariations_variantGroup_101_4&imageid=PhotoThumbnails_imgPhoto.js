...
VariantSwatchesProductVariations_variantGroup_101_4 = {
SwatchArray: { 197: {
                        SwatchURL: '/Shared/images/Product/Sensitive Eyes Mascara Swatches/brown-sensetive.jpg',
                        ControlPath: 'ProductVariations_variantGroup_101_4'
                    }, 198: {
                        SwatchURL: '/Shared/images/Product/Sensitive Eyes Mascara Swatches/black-sensetive-eyes.jpg',
                        ControlPath: 'ProductVariations_variantGroup_101_4'
                    }, 199: {
                        SwatchURL: '/Shared/images/Product/Sensitive Eyes Mascara Swatches/navy-sensetive.jpg',
                        ControlPath: 'ProductVariations_variantGroup_101_4'
                    } },
  ImagingMode: "Resizer",
  ...
  SelectVariant: function(groupID, variantID, setDropDown) {
    ...
    var o = VariantSwatchesProductVariations_variantGroup_101_4.SwatchArray[variantID];
    if (o) {
      if (setDropDown)
...
$(function(){
	...
	$("select[id$='ProductVariations_variantGroup_101_4']").change(function() { VariantSwatchesProductVariations_variantGroup_101_4.SelectVariant( $(this).parent().find("input[type=hidden]").val() , $(this).val(), false) });

    // Bind radio button selection event
    $("input[type=radio][name$='ProductVariations_variantGroup_101_4']").change(function() {
        VariantSwatchesProductVariations_variantGroup_101_4.SelectVariant( $(this).closest('.ProductDetailsVariations').find('.ProductDetailsVariations').find("input[type=hidden]").val() , $(this).val(), false);
    });
})
