...
VariantSwatchesProductVariations_variantGroup_299_4 = {
SwatchArray: { 402: {
                        SwatchURL: '/images/Rosy-Glow.jpg',
                        ControlPath: 'ProductVariations_variantGroup_299_4'
                    }, 401: {
                        SwatchURL: '/images/Sandy-Beach.jpg',
                        ControlPath: 'ProductVariations_variantGroup_299_4'
                    }, 403: {
                        SwatchURL: '/images/Sunset-Sheer.jpg',
                        ControlPath: 'ProductVariations_variantGroup_299_4'
                    }, 405: {
                        SwatchURL: '/images/Pink-Pearl.jpg',
                        ControlPath: 'ProductVariations_variantGroup_299_4'
                    }, 404: {
                        SwatchURL: '/images/Cherry-Glaze.jpg',
                        ControlPath: 'ProductVariations_variantGroup_299_4'
                    } },
  ImagingMode: "Resizer",
  ...
  SelectVariant: function(groupID, variantID, setDropDown) {
    ...
    var o = VariantSwatchesProductVariations_variantGroup_299_4.SwatchArray[variantID];
    if (o) {
      if (setDropDown)
...
$(function(){
	...
	$("select[id$='ProductVariations_variantGroup_299_4']").change(function() { VariantSwatchesProductVariations_variantGroup_299_4.SelectVariant( $(this).parent().find("input[type=hidden]").val() , $(this).val(), false) });

    // Bind radio button selection event
    $("input[type=radio][name$='ProductVariations_variantGroup_299_4']").change(function() {
        VariantSwatchesProductVariations_variantGroup_299_4.SelectVariant( $(this).closest('.ProductDetailsVariations').find('.ProductDetailsVariations').find("input[type=hidden]").val() , $(this).val(), false);
    });
})
