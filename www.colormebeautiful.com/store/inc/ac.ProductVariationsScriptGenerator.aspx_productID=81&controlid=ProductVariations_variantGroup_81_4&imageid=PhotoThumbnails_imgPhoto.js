...
VariantSwatchesProductVariations_variantGroup_81_4 = {
SwatchArray: { 138: {
                        SwatchURL: '/Shared/images/Product/Corrective Concealer Swatches/clay2.jpg',
                        ControlPath: 'ProductVariations_variantGroup_81_4'
                    }, 139: {
                        SwatchURL: '/Shared/images/Product/Corrective Concealer Swatches/earth2.jpg',
                        ControlPath: 'ProductVariations_variantGroup_81_4'
                    } },
  ImagingMode: "Resizer",
  ...
  SelectVariant: function(groupID, variantID, setDropDown) {
    ...
    var o = VariantSwatchesProductVariations_variantGroup_81_4.SwatchArray[variantID];
    if (o) {
      if (setDropDown)
...
$(function(){
	...
	$("select[id$='ProductVariations_variantGroup_81_4']").change(function() { VariantSwatchesProductVariations_variantGroup_81_4.SelectVariant( $(this).parent().find("input[type=hidden]").val() , $(this).val(), false) });

    // Bind radio button selection event
    $("input[type=radio][name$='ProductVariations_variantGroup_81_4']").change(function() {
        VariantSwatchesProductVariations_variantGroup_81_4.SelectVariant( $(this).closest('.ProductDetailsVariations').find('.ProductDetailsVariations').find("input[type=hidden]").val() , $(this).val(), false);
    });
})
