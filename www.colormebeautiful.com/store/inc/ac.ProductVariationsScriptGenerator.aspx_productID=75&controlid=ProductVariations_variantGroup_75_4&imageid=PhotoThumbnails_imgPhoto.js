...
VariantSwatchesProductVariations_variantGroup_75_4 = {
SwatchArray: { 119: {
                        SwatchURL: '/Shared/images/Product/Flawless Loose Mineral Foundation Swatches/light.jpg',
                        ControlPath: 'ProductVariations_variantGroup_75_4'
                    }, 120: {
                        SwatchURL: '/Shared/images/Product/Flawless Loose Mineral Foundation Swatches/beige.jpg',
                        ControlPath: 'ProductVariations_variantGroup_75_4'
                    }, 121: {
                        SwatchURL: '/Shared/images/Product/Flawless Loose Mineral Foundation Swatches/tan.jpg',
                        ControlPath: 'ProductVariations_variantGroup_75_4'
                    } },
  ImagingMode: "Resizer",
  ...
  SelectVariant: function(groupID, variantID, setDropDown) {
    ...
    var o = VariantSwatchesProductVariations_variantGroup_75_4.SwatchArray[variantID];
    if (o) {
      if (setDropDown)
...
$(function(){
	...
	$("select[id$='ProductVariations_variantGroup_75_4']").change(function() { VariantSwatchesProductVariations_variantGroup_75_4.SelectVariant( $(this).parent().find("input[type=hidden]").val() , $(this).val(), false) });

    // Bind radio button selection event
    $("input[type=radio][name$='ProductVariations_variantGroup_75_4']").change(function() {
        VariantSwatchesProductVariations_variantGroup_75_4.SelectVariant( $(this).closest('.ProductDetailsVariations').find('.ProductDetailsVariations').find("input[type=hidden]").val() , $(this).val(), false);
    });
})
