...
VariantSwatchesProductVariations_variantGroup_35_4 = {
SwatchArray: { 307: {
                        SwatchURL: '/Shared/images/Product/High Shine Lip Lacquer Swatches/flirt.jpg',
                        ControlPath: 'ProductVariations_variantGroup_35_4'
                    }, 309: {
                        SwatchURL: '/Shared/images/Product/High Shine Lip Lacquer Swatches/poised.jpg',
                        ControlPath: 'ProductVariations_variantGroup_35_4'
                    }, 35: {
                        SwatchURL: '/Shared/images/Product/High Shine Lip Lacquer Swatches/pink-roses.jpg',
                        ControlPath: 'ProductVariations_variantGroup_35_4'
                    }, 34: {
                        SwatchURL: '/Shared/images/Product/High Shine Lip Lacquer Swatches/perfect-plumhigh.jpg',
                        ControlPath: 'ProductVariations_variantGroup_35_4'
                    } },
  ImagingMode: "Resizer",
  ...
  SelectVariant: function(groupID, variantID, setDropDown) {
    ...
    var o = VariantSwatchesProductVariations_variantGroup_35_4.SwatchArray[variantID];
    if (o) {
      if (setDropDown)
...
$(function(){
	...
	$("select[id$='ProductVariations_variantGroup_35_4']").change(function() { VariantSwatchesProductVariations_variantGroup_35_4.SelectVariant( $(this).parent().find("input[type=hidden]").val() , $(this).val(), false) });

    // Bind radio button selection event
    $("input[type=radio][name$='ProductVariations_variantGroup_35_4']").change(function() {
        VariantSwatchesProductVariations_variantGroup_35_4.SelectVariant( $(this).closest('.ProductDetailsVariations').find('.ProductDetailsVariations').find("input[type=hidden]").val() , $(this).val(), false);
    });
})
