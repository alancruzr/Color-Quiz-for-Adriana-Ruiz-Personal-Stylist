...
VariantSwatchesProductVariations_variantGroup_56_4 = {
SwatchArray: { 88: {
                        SwatchURL: '/Shared/images/Product/All Nighter Matte Liquid Lip Swatches/selfie-swatch.jpg',
                        ControlPath: 'ProductVariations_variantGroup_56_4'
                    }, 90: {
                        SwatchURL: '/Shared/images/Product/All Nighter Matte Liquid Lip Swatches/slay-swatch.jpg',
                        ControlPath: 'ProductVariations_variantGroup_56_4'
                    }, 431: {
                        SwatchURL: '/Shared/images/Product/All Nighter Matte Liquid Lip Swatches/finesse-swatch.jpg',
                        ControlPath: 'ProductVariations_variantGroup_56_4'
                    }, 89: {
                        SwatchURL: '/Shared/images/Product/All Nighter Matte Liquid Lip Swatches/on-point.jpg',
                        ControlPath: 'ProductVariations_variantGroup_56_4'
                    }, 86: {
                        SwatchURL: '/Shared/images/Product/All Nighter Matte Liquid Lip Swatches/Boss-swatch.jpg',
                        ControlPath: 'ProductVariations_variantGroup_56_4'
                    }, 430: {
                        SwatchURL: '/Shared/images/Product/All Nighter Matte Liquid Lip Swatches/Vibe-swatch-web.jpg',
                        ControlPath: 'ProductVariations_variantGroup_56_4'
                    } },
  ImagingMode: "Resizer",
  ...
  SelectVariant: function(groupID, variantID, setDropDown) {
    ...
    var o = VariantSwatchesProductVariations_variantGroup_56_4.SwatchArray[variantID];
    if (o) {
      if (setDropDown)
...
$(function(){
	...
	$("select[id$='ProductVariations_variantGroup_56_4']").change(function() { VariantSwatchesProductVariations_variantGroup_56_4.SelectVariant( $(this).parent().find("input[type=hidden]").val() , $(this).val(), false) });

    // Bind radio button selection event
    $("input[type=radio][name$='ProductVariations_variantGroup_56_4']").change(function() {
        VariantSwatchesProductVariations_variantGroup_56_4.SelectVariant( $(this).closest('.ProductDetailsVariations').find('.ProductDetailsVariations').find("input[type=hidden]").val() , $(this).val(), false);
    });
})
