...
VariantSwatchesProductVariations_variantGroup_38_4 = {
SwatchArray: { 80: {
                        SwatchURL: '/Shared/images/Product/Base Strokes Foundation Stick Swatches/praline.jpg',
                        ControlPath: 'ProductVariations_variantGroup_38_4'
                    }, 81: {
                        SwatchURL: '/Shared/images/Product/Base Strokes Foundation Stick Swatches/Toasted-almond.jpg',
                        ControlPath: 'ProductVariations_variantGroup_38_4'
                    }, 79: {
                        SwatchURL: '/Shared/images/Product/Base Strokes Foundation Stick Swatches/gazelle.jpg',
                        ControlPath: 'ProductVariations_variantGroup_38_4'
                    }, 78: {
                        SwatchURL: '/Shared/images/Product/Base Strokes Foundation Stick Swatches/cognac.jpg',
                        ControlPath: 'ProductVariations_variantGroup_38_4'
                    }, 82: {
                        SwatchURL: '/Shared/images/Product/Base Strokes Foundation Stick Swatches/Sable.jpg',
                        ControlPath: 'ProductVariations_variantGroup_38_4'
                    }, 83: {
                        SwatchURL: '/Shared/images/Product/Base Strokes Foundation Stick Swatches/truffle.jpg',
                        ControlPath: 'ProductVariations_variantGroup_38_4'
                    }, 84: {
                        SwatchURL: '/Shared/images/Product/Base Strokes Foundation Stick Swatches/java.jpg',
                        ControlPath: 'ProductVariations_variantGroup_38_4'
                    } },
  ImagingMode: "Resizer",
  ...
  SelectVariant: function(groupID, variantID, setDropDown) {
    ...
    var o = VariantSwatchesProductVariations_variantGroup_38_4.SwatchArray[variantID];
    if (o) {
      if (setDropDown)
...
$(function(){
	...
	$("select[id$='ProductVariations_variantGroup_38_4']").change(function() { VariantSwatchesProductVariations_variantGroup_38_4.SelectVariant( $(this).parent().find("input[type=hidden]").val() , $(this).val(), false) });

    // Bind radio button selection event
    $("input[type=radio][name$='ProductVariations_variantGroup_38_4']").change(function() {
        VariantSwatchesProductVariations_variantGroup_38_4.SelectVariant( $(this).closest('.ProductDetailsVariations').find('.ProductDetailsVariations').find("input[type=hidden]").val() , $(this).val(), false);
    });
})
