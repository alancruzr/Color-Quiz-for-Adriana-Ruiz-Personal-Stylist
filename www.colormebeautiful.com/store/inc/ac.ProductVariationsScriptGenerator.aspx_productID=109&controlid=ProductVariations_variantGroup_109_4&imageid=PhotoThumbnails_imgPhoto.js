...
VariantSwatchesProductVariations_variantGroup_109_4 = {
SwatchArray: { 247: {
                        SwatchURL: '/Shared/images/Product/Loose Mineral Eyeshadow Swatches/dusky-cmb.jpg',
                        ControlPath: 'ProductVariations_variantGroup_109_4'
                    }, 249: {
                        SwatchURL: '/Shared/images/Product/Loose Mineral Eyeshadow Swatches/449790-Gold-Rush.jpg',
                        ControlPath: 'ProductVariations_variantGroup_109_4'
                    }, 245: {
                        SwatchURL: '/Shared/images/Product/Loose Mineral Eyeshadow Swatches/449769-Grape-Crush.jpg',
                        ControlPath: 'ProductVariations_variantGroup_109_4'
                    }, 389: {
                        SwatchURL: '/Shared/images/Product/Loose Mineral Eyeshadow Swatches/eggweb.jpg',
                        ControlPath: 'ProductVariations_variantGroup_109_4'
                    }, 251: {
                        SwatchURL: '/Shared/images/Product/Loose Mineral Eyeshadow Swatches/449776-Chocolate-Ice.jpg',
                        ControlPath: 'ProductVariations_variantGroup_109_4'
                    }, 390: {
                        SwatchURL: '/Shared/images/Product/Loose Mineral Eyeshadow Swatches/deep-sea.jpg',
                        ControlPath: 'ProductVariations_variantGroup_109_4'
                    } },
  ImagingMode: "Resizer",
  ...
  SelectVariant: function(groupID, variantID, setDropDown) {
    ...
    var o = VariantSwatchesProductVariations_variantGroup_109_4.SwatchArray[variantID];
    if (o) {
      if (setDropDown)
...
$(function(){
	...
	$("select[id$='ProductVariations_variantGroup_109_4']").change(function() { VariantSwatchesProductVariations_variantGroup_109_4.SelectVariant( $(this).parent().find("input[type=hidden]").val() , $(this).val(), false) });

    // Bind radio button selection event
    $("input[type=radio][name$='ProductVariations_variantGroup_109_4']").change(function() {
        VariantSwatchesProductVariations_variantGroup_109_4.SelectVariant( $(this).closest('.ProductDetailsVariations').find('.ProductDetailsVariations').find("input[type=hidden]").val() , $(this).val(), false);
    });
})
