...
VariantSwatchesProductVariations_variantGroup_119_4 = {
SwatchArray: { 287: {
                        SwatchURL: '/Shared/images/Product/Compact Eyeshadow Trio Swatches/eyeshadtrio-web.jpg',
                        ControlPath: 'ProductVariations_variantGroup_119_4'
                    }, 285: {
                        SwatchURL: '/Shared/images/Product/Compact Eyeshadow Trio Swatches/palm.jpg',
                        ControlPath: 'ProductVariations_variantGroup_119_4'
                    }, 281: {
                        SwatchURL: '/Shared/images/Product/Compact Eyeshadow Trio Swatches/sandybeacheyetrio.jpg',
                        ControlPath: 'ProductVariations_variantGroup_119_4'
                    } },
  ImagingMode: "Resizer",
  ...
  SelectVariant: function(groupID, variantID, setDropDown) {
    ...
    var o = VariantSwatchesProductVariations_variantGroup_119_4.SwatchArray[variantID];
    if (o) {
      if (setDropDown)
...
$(function(){
	...
	$("select[id$='ProductVariations_variantGroup_119_4']").change(function() { VariantSwatchesProductVariations_variantGroup_119_4.SelectVariant( $(this).parent().find("input[type=hidden]").val() , $(this).val(), false) });

    // Bind radio button selection event
    $("input[type=radio][name$='ProductVariations_variantGroup_119_4']").change(function() {
        VariantSwatchesProductVariations_variantGroup_119_4.SelectVariant( $(this).closest('.ProductDetailsVariations').find('.ProductDetailsVariations').find("input[type=hidden]").val() , $(this).val(), false);
    });
})
