...
VariantSwatchesProductVariations_variantGroup_105_4 = {
SwatchArray: { 207: {
                        SwatchURL: '/Shared/images/Product/Eye Pencil Swatches/black-magic.jpg',
                        ControlPath: 'ProductVariations_variantGroup_105_4'
                    }, 208: {
                        SwatchURL: '/Shared/images/Product/Eye Pencil Swatches/dark-chocolate.jpg',
                        ControlPath: 'ProductVariations_variantGroup_105_4'
                    }, 394: {
                        SwatchURL: '/Shared/images/Product/Eye Pencil Swatches/khaki.jpg',
                        ControlPath: 'ProductVariations_variantGroup_105_4'
                    }, 209: {
                        SwatchURL: '/Shared/images/Product/Eye Pencil Swatches/perfect-grey.jpg',
                        ControlPath: 'ProductVariations_variantGroup_105_4'
                    }, 210: {
                        SwatchURL: '/Shared/images/Product/Eye Pencil Swatches/rich-navy.jpg',
                        ControlPath: 'ProductVariations_variantGroup_105_4'
                    } },
  ImagingMode: "Resizer",
  ...
  SelectVariant: function(groupID, variantID, setDropDown) {
    ...
    var o = VariantSwatchesProductVariations_variantGroup_105_4.SwatchArray[variantID];
    if (o) {
      if (setDropDown)
...
$(function(){
	...
	$("select[id$='ProductVariations_variantGroup_105_4']").change(function() { VariantSwatchesProductVariations_variantGroup_105_4.SelectVariant( $(this).parent().find("input[type=hidden]").val() , $(this).val(), false) });

    // Bind radio button selection event
    $("input[type=radio][name$='ProductVariations_variantGroup_105_4']").change(function() {
        VariantSwatchesProductVariations_variantGroup_105_4.SelectVariant( $(this).closest('.ProductDetailsVariations').find('.ProductDetailsVariations').find("input[type=hidden]").val() , $(this).val(), false);
    });
})
