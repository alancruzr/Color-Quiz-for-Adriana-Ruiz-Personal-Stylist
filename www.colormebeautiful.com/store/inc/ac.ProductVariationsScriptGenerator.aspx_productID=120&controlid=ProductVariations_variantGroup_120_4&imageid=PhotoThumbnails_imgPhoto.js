...
VariantSwatchesProductVariations_variantGroup_120_4 = {
SwatchArray: { 292: {
                        SwatchURL: '/Shared/images/Product/Luxury-Eye-Shadow-Trio/0931269_oliveGrove.jpg',
                        ControlPath: 'ProductVariations_variantGroup_120_4'
                    }, 290: {
                        SwatchURL: 'http://galehayman.com/images/0931267_primalinstincts.jpg',
                        ControlPath: 'ProductVariations_variantGroup_120_4'
                    }, 289: {
                        SwatchURL: '/Shared/images/Product/GH Luxury Eyeshadow Trio Swatches/0931264_rodeodrive.jpg',
                        ControlPath: 'ProductVariations_variantGroup_120_4'
                    } },
  ImagingMode: "Resizer",
  ...
  SelectVariant: function(groupID, variantID, setDropDown) {
    ...
    var o = VariantSwatchesProductVariations_variantGroup_120_4.SwatchArray[variantID];
    if (o) {
      if (setDropDown)
...
$(function(){
	...
	$("select[id$='ProductVariations_variantGroup_120_4']").change(function() { VariantSwatchesProductVariations_variantGroup_120_4.SelectVariant( $(this).parent().find("input[type=hidden]").val() , $(this).val(), false) });

    // Bind radio button selection event
    $("input[type=radio][name$='ProductVariations_variantGroup_120_4']").change(function() {
        VariantSwatchesProductVariations_variantGroup_120_4.SelectVariant( $(this).closest('.ProductDetailsVariations').find('.ProductDetailsVariations').find("input[type=hidden]").val() , $(this).val(), false);
    });
})
