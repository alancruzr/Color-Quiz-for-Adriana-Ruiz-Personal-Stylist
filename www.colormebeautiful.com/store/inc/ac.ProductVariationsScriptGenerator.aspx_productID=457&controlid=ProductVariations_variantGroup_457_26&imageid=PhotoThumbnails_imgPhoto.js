...
VariantSwatchesProductVariations_variantGroup_457_26 = {
SwatchArray: { 630: {
                        SwatchURL: '/images/autumn-kit.jpg',
                        ControlPath: 'ProductVariations_variantGroup_457_26'
                    }, 632: {
                        SwatchURL: '/images/spring-kit.jpg',
                        ControlPath: 'ProductVariations_variantGroup_457_26'
                    }, 631: {
                        SwatchURL: '/images/summer-kit.jpg',
                        ControlPath: 'ProductVariations_variantGroup_457_26'
                    }, 629: {
                        SwatchURL: '/images/winter-kit.jpg',
                        ControlPath: 'ProductVariations_variantGroup_457_26'
                    } },
  ImagingMode: "Resizer",
  ...
  SelectVariant: function(groupID, variantID, setDropDown) {
    ...
    var o = VariantSwatchesProductVariations_variantGroup_457_26.SwatchArray[variantID];
    if (o) {
      if (setDropDown)
...
$(function(){
	...
	$("select[id$='ProductVariations_variantGroup_457_26']").change(function() { VariantSwatchesProductVariations_variantGroup_457_26.SelectVariant( $(this).parent().find("input[type=hidden]").val() , $(this).val(), false) });

    // Bind radio button selection event
    $("input[type=radio][name$='ProductVariations_variantGroup_457_26']").change(function() {
        VariantSwatchesProductVariations_variantGroup_457_26.SelectVariant( $(this).closest('.ProductDetailsVariations').find('.ProductDetailsVariations').find("input[type=hidden]").val() , $(this).val(), false);
    });
})
