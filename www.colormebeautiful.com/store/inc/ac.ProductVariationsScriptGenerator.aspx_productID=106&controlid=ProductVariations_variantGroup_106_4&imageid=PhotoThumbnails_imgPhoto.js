...
VariantSwatchesProductVariations_variantGroup_106_4 = {
SwatchArray: { 211: {
                        SwatchURL: '/Shared/images/Product/Chroma Soft Eye Pencil Swatches/Aubergine.jpg',
                        ControlPath: 'ProductVariations_variantGroup_106_4'
                    }, 212: {
                        SwatchURL: '/Shared/images/Product/Chroma Soft Eye Pencil Swatches/Brown.jpg',
                        ControlPath: 'ProductVariations_variantGroup_106_4'
                    }, 213: {
                        SwatchURL: '/Shared/images/Product/Chroma Soft Eye Pencil Swatches/483398.jpg',
                        ControlPath: 'ProductVariations_variantGroup_106_4'
                    }, 214: {
                        SwatchURL: '/Shared/images/Product/Chroma Soft Eye Pencil Swatches/483427.jpg',
                        ControlPath: 'ProductVariations_variantGroup_106_4'
                    }, 215: {
                        SwatchURL: '/Shared/images/Product/Chroma Soft Eye Pencil Swatches/483466.jpg',
                        ControlPath: 'ProductVariations_variantGroup_106_4'
                    }, 216: {
                        SwatchURL: '/Shared/images/Product/Chroma Soft Eye Pencil Swatches/483480.jpg',
                        ControlPath: 'ProductVariations_variantGroup_106_4'
                    }, 217: {
                        SwatchURL: '/Shared/images/Product/Chroma Soft Eye Pencil Swatches/483473.jpg',
                        ControlPath: 'ProductVariations_variantGroup_106_4'
                    }, 218: {
                        SwatchURL: '/Shared/images/Product/Chroma Soft Eye Pencil Swatches/483404.jpg',
                        ControlPath: 'ProductVariations_variantGroup_106_4'
                    } },
  ImagingMode: "Resizer",
  ...
  SelectVariant: function(groupID, variantID, setDropDown) {
    ...
    var o = VariantSwatchesProductVariations_variantGroup_106_4.SwatchArray[variantID];
    if (o) {
      if (setDropDown)
...
$(function(){
	...
	$("select[id$='ProductVariations_variantGroup_106_4']").change(function() { VariantSwatchesProductVariations_variantGroup_106_4.SelectVariant( $(this).parent().find("input[type=hidden]").val() , $(this).val(), false) });

    // Bind radio button selection event
    $("input[type=radio][name$='ProductVariations_variantGroup_106_4']").change(function() {
        VariantSwatchesProductVariations_variantGroup_106_4.SelectVariant( $(this).closest('.ProductDetailsVariations').find('.ProductDetailsVariations').find("input[type=hidden]").val() , $(this).val(), false);
    });
})
