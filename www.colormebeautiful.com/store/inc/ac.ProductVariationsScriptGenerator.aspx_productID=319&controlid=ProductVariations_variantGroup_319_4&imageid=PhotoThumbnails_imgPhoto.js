...
VariantSwatchesProductVariations_variantGroup_319_4 = {
SwatchArray: { 424: {
                        SwatchURL: '/Shared/images/Product/Lip-Lift Lip Conditioner Swatches/clear-regular-lip-lift-big.jpg',
                        ControlPath: 'ProductVariations_variantGroup_319_4'
                    }, 428: {
                        SwatchURL: '/Shared/images/Product/Lip-Lift Lip Conditioner Swatches/mint-big.jpg',
                        ControlPath: 'ProductVariations_variantGroup_319_4'
                    }, 423: {
                        SwatchURL: '/Shared/images/Product/Lip-Lift Lip Conditioner Swatches/14K-big.jpg',
                        ControlPath: 'ProductVariations_variantGroup_319_4'
                    }, 427: {
                        SwatchURL: '/Shared/images/Product/Lip-Lift Lip Conditioner Swatches/petal-big.jpg',
                        ControlPath: 'ProductVariations_variantGroup_319_4'
                    }, 426: {
                        SwatchURL: '/Shared/images/Product/Lip-Lift Lip Conditioner Swatches/Blush-big.jpg',
                        ControlPath: 'ProductVariations_variantGroup_319_4'
                    }, 425: {
                        SwatchURL: '/Shared/images/Product/Lip-Lift Lip Conditioner Swatches/blackberry-big.jpg',
                        ControlPath: 'ProductVariations_variantGroup_319_4'
                    } },
  ImagingMode: "Resizer",
  ...
  SelectVariant: function(groupID, variantID, setDropDown) {
    ...
    var o = VariantSwatchesProductVariations_variantGroup_319_4.SwatchArray[variantID];
    if (o) {
      if (setDropDown)
...
$(function(){
	...
	$("select[id$='ProductVariations_variantGroup_319_4']").change(function() { VariantSwatchesProductVariations_variantGroup_319_4.SelectVariant( $(this).parent().find("input[type=hidden]").val() , $(this).val(), false) });

    // Bind radio button selection event
    $("input[type=radio][name$='ProductVariations_variantGroup_319_4']").change(function() {
        VariantSwatchesProductVariations_variantGroup_319_4.SelectVariant( $(this).closest('.ProductDetailsVariations').find('.ProductDetailsVariations').find("input[type=hidden]").val() , $(this).val(), false);
    });
})
