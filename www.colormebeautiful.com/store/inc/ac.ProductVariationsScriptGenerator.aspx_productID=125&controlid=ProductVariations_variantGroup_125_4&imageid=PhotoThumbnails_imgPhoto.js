...
VariantSwatchesProductVariations_variantGroup_125_4 = {
SwatchArray: { 312: {
                        SwatchURL: '/Shared/images/Product/Lip-Lift/liplift.jpg',
                        ControlPath: 'ProductVariations_variantGroup_125_4'
                    }, 313: {
                        SwatchURL: '/Shared/images/Product/Lip-Lift/mint.jpg',
                        ControlPath: 'ProductVariations_variantGroup_125_4'
                    } },
  ImagingMode: "Resizer",
  ...
  SelectVariant: function(groupID, variantID, setDropDown) {
    ...
    var o = VariantSwatchesProductVariations_variantGroup_125_4.SwatchArray[variantID];
    if (o) {
      if (setDropDown)
...
$(function(){
	...
	$("select[id$='ProductVariations_variantGroup_125_4']").change(function() { VariantSwatchesProductVariations_variantGroup_125_4.SelectVariant( $(this).parent().find("input[type=hidden]").val() , $(this).val(), false) });

    // Bind radio button selection event
    $("input[type=radio][name$='ProductVariations_variantGroup_125_4']").change(function() {
        VariantSwatchesProductVariations_variantGroup_125_4.SelectVariant( $(this).closest('.ProductDetailsVariations').find('.ProductDetailsVariations').find("input[type=hidden]").val() , $(this).val(), false);
    });
})
