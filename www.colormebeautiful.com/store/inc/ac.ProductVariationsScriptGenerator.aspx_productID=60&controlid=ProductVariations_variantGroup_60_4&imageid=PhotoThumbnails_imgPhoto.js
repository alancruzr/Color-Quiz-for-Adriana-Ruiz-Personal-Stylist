...
VariantSwatchesProductVariations_variantGroup_60_4 = {
SwatchArray: { 226: {
                        SwatchURL: '/Shared/images/Product/CMB Lip Pencil Swatches/437964.jpg',
                        ControlPath: 'ProductVariations_variantGroup_60_4'
                    }, 227: {
                        SwatchURL: '/Shared/images/Product/CMB Lip Pencil Swatches/437971.jpg',
                        ControlPath: 'ProductVariations_variantGroup_60_4'
                    }, 228: {
                        SwatchURL: '/Shared/images/Product/CMB Lip Pencil Swatches/437933.jpg',
                        ControlPath: 'ProductVariations_variantGroup_60_4'
                    }, 230: {
                        SwatchURL: '/Shared/images/Product/CMB Lip Pencil Swatches/437995.jpg',
                        ControlPath: 'ProductVariations_variantGroup_60_4'
                    }, 231: {
                        SwatchURL: '/Shared/images/Product/CMB Lip Pencil Swatches/437957.jpg',
                        ControlPath: 'ProductVariations_variantGroup_60_4'
                    }, 232: {
                        SwatchURL: '/Shared/images/Product/CMB Lip Pencil Swatches/tangerine.jpg',
                        ControlPath: 'ProductVariations_variantGroup_60_4'
                    } },
  ImagingMode: "Resizer",
  ...
  SelectVariant: function(groupID, variantID, setDropDown) {
    ...
    var o = VariantSwatchesProductVariations_variantGroup_60_4.SwatchArray[variantID];
    if (o) {
      if (setDropDown)
...
$(function(){
	...
	$("select[id$='ProductVariations_variantGroup_60_4']").change(function() { VariantSwatchesProductVariations_variantGroup_60_4.SelectVariant( $(this).parent().find("input[type=hidden]").val() , $(this).val(), false) });

    // Bind radio button selection event
    $("input[type=radio][name$='ProductVariations_variantGroup_60_4']").change(function() {
        VariantSwatchesProductVariations_variantGroup_60_4.SelectVariant( $(this).closest('.ProductDetailsVariations').find('.ProductDetailsVariations').find("input[type=hidden]").val() , $(this).val(), false);
    });
})
