...
VariantSwatchesProductVariations_variantGroup_421_4 = {
SwatchArray: { 432: {
                        SwatchURL: '/images/flutter-swatch.jpg',
                        ControlPath: 'ProductVariations_variantGroup_421_4'
                    }, 433: {
                        SwatchURL: '/images/peace-swatch.jpg',
                        ControlPath: 'ProductVariations_variantGroup_421_4'
                    } },
  ImagingMode: "Resizer",
  ...
  SelectVariant: function(groupID, variantID, setDropDown) {
    ...
    var o = VariantSwatchesProductVariations_variantGroup_421_4.SwatchArray[variantID];
    if (o) {
      if (setDropDown)
...
$(function(){
	...
	$("select[id$='ProductVariations_variantGroup_421_4']").change(function() { VariantSwatchesProductVariations_variantGroup_421_4.SelectVariant( $(this).parent().find("input[type=hidden]").val() , $(this).val(), false) });

    // Bind radio button selection event
    $("input[type=radio][name$='ProductVariations_variantGroup_421_4']").change(function() {
        VariantSwatchesProductVariations_variantGroup_421_4.SelectVariant( $(this).closest('.ProductDetailsVariations').find('.ProductDetailsVariations').find("input[type=hidden]").val() , $(this).val(), false);
    });
})
