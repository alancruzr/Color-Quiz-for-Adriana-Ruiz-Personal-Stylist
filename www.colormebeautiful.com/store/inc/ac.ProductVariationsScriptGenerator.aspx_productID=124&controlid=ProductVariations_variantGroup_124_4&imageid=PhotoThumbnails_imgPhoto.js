...
VariantSwatchesProductVariations_variantGroup_124_4 = {
SwatchArray: { 293: {
                        SwatchURL: '/Shared/images/Product/GH Lip-Lift Tints/14k-swatch-lip-lift.jpg',
                        ControlPath: 'ProductVariations_variantGroup_124_4'
                    }, 295: {
                        SwatchURL: '/Shared/images/Product/GH Lip-Lift Tints/blackberry-swatch-lip-lift.jpg',
                        ControlPath: 'ProductVariations_variantGroup_124_4'
                    }, 294: {
                        SwatchURL: '/Shared/images/Product/GH Lip-Lift Tints/blush-swatch.jpg',
                        ControlPath: 'ProductVariations_variantGroup_124_4'
                    } },
  ImagingMode: "Resizer",
  ...
  SelectVariant: function(groupID, variantID, setDropDown) {
    ...
    var o = VariantSwatchesProductVariations_variantGroup_124_4.SwatchArray[variantID];
    if (o) {
      if (setDropDown)
...
$(function(){
	...
	$("select[id$='ProductVariations_variantGroup_124_4']").change(function() { VariantSwatchesProductVariations_variantGroup_124_4.SelectVariant( $(this).parent().find("input[type=hidden]").val() , $(this).val(), false) });

    // Bind radio button selection event
    $("input[type=radio][name$='ProductVariations_variantGroup_124_4']").change(function() {
        VariantSwatchesProductVariations_variantGroup_124_4.SelectVariant( $(this).closest('.ProductDetailsVariations').find('.ProductDetailsVariations').find("input[type=hidden]").val() , $(this).val(), false);
    });
})
