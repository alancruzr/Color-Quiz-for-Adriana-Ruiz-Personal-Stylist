...
VariantSwatchesProductVariations_variantGroup_587_26 = {
SwatchArray: { 1040: {
                        SwatchURL: '/images/warm-collections.jpg',
                        ControlPath: 'ProductVariations_variantGroup_587_26'
                    }, 1039: {
                        SwatchURL: '/images/Cool-lip-collection.jpg',
                        ControlPath: 'ProductVariations_variantGroup_587_26'
                    } },
  ImagingMode: "Resizer",
  ...
  SelectVariant: function(groupID, variantID, setDropDown) {
    ...
    var o = VariantSwatchesProductVariations_variantGroup_587_26.SwatchArray[variantID];
    if (o) {
      if (setDropDown)
...
$(function(){
	...
	$("select[id$='ProductVariations_variantGroup_587_26']").change(function() { VariantSwatchesProductVariations_variantGroup_587_26.SelectVariant( $(this).parent().find("input[type=hidden]").val() , $(this).val(), false) });

    // Bind radio button selection event
    $("input[type=radio][name$='ProductVariations_variantGroup_587_26']").change(function() {
        VariantSwatchesProductVariations_variantGroup_587_26.SelectVariant( $(this).closest('.ProductDetailsVariations').find('.ProductDetailsVariations').find("input[type=hidden]").val() , $(this).val(), false);
    });
})
