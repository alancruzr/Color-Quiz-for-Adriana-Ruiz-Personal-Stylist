...
VariantSwatchesProductVariations_variantGroup_82_4 = {
SwatchArray: { 141: {
                        SwatchURL: '/Shared/images/Product/Luxury Oil Blotting Pressed Powder Swatches/invisibleswatch.jpg',
                        ControlPath: 'ProductVariations_variantGroup_82_4'
                    }, 143: {
                        SwatchURL: '/Shared/images/Product/Luxury Oil Blotting Pressed Powder Swatches/honeyswatch.jpg',
                        ControlPath: 'ProductVariations_variantGroup_82_4'
                    }, 142: {
                        SwatchURL: '/Shared/images/Product/Luxury Oil Blotting Pressed Powder Swatches/amberswatchp.jpg',
                        ControlPath: 'ProductVariations_variantGroup_82_4'
                    }, 144: {
                        SwatchURL: '/Shared/images/Product/Luxury Oil Blotting Pressed Powder Swatches/tawnyswatchp.jpg',
                        ControlPath: 'ProductVariations_variantGroup_82_4'
                    }, 145: {
                        SwatchURL: '/Shared/images/Product/Luxury Oil Blotting Pressed Powder Swatches/toastswatch.jpg',
                        ControlPath: 'ProductVariations_variantGroup_82_4'
                    }, 147: {
                        SwatchURL: '/Shared/images/Product/Luxury Oil Blotting Pressed Powder Swatches/coffeeswatch.jpg',
                        ControlPath: 'ProductVariations_variantGroup_82_4'
                    }, 146: {
                        SwatchURL: '/Shared/images/Product/Luxury Oil Blotting Pressed Powder Swatches/spiceswatch.jpg',
                        ControlPath: 'ProductVariations_variantGroup_82_4'
                    }, 148: {
                        SwatchURL: '/Shared/images/Product/Luxury Oil Blotting Pressed Powder Swatches/Brownswatch.jpg',
                        ControlPath: 'ProductVariations_variantGroup_82_4'
                    }, 149: {
                        SwatchURL: '/Shared/images/Product/Luxury Oil Blotting Pressed Powder Swatches/mediumswatch.jpg',
                        ControlPath: 'ProductVariations_variantGroup_82_4'
                    } },
  ImagingMode: "Resizer",
  ...
  SelectVariant: function(groupID, variantID, setDropDown) {
    ...
    var o = VariantSwatchesProductVariations_variantGroup_82_4.SwatchArray[variantID];
    if (o) {
      if (setDropDown)
...
$(function(){
	...
	$("select[id$='ProductVariations_variantGroup_82_4']").change(function() { VariantSwatchesProductVariations_variantGroup_82_4.SelectVariant( $(this).parent().find("input[type=hidden]").val() , $(this).val(), false) });

    // Bind radio button selection event
    $("input[type=radio][name$='ProductVariations_variantGroup_82_4']").change(function() {
        VariantSwatchesProductVariations_variantGroup_82_4.SelectVariant( $(this).closest('.ProductDetailsVariations').find('.ProductDetailsVariations').find("input[type=hidden]").val() , $(this).val(), false);
    });
})
