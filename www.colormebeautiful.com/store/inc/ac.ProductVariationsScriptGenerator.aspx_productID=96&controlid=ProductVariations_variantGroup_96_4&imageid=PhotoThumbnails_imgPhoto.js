...
VariantSwatchesProductVariations_variantGroup_96_4 = {
SwatchArray: { 192: {
                        SwatchURL: '/images/cedar-rose_472163.jpg',
                        ControlPath: 'ProductVariations_variantGroup_96_4'
                    }, 195: {
                        SwatchURL: '/images/softplum_472132.jpg',
                        ControlPath: 'ProductVariations_variantGroup_96_4'
                    } },
  ImagingMode: "Resizer",
  ...
  SelectVariant: function(groupID, variantID, setDropDown) {
    ...
    var o = VariantSwatchesProductVariations_variantGroup_96_4.SwatchArray[variantID];
    if (o) {
      if (setDropDown)
...
$(function(){
	...
	$("select[id$='ProductVariations_variantGroup_96_4']").change(function() { VariantSwatchesProductVariations_variantGroup_96_4.SelectVariant( $(this).parent().find("input[type=hidden]").val() , $(this).val(), false) });

    // Bind radio button selection event
    $("input[type=radio][name$='ProductVariations_variantGroup_96_4']").change(function() {
        VariantSwatchesProductVariations_variantGroup_96_4.SelectVariant( $(this).closest('.ProductDetailsVariations').find('.ProductDetailsVariations').find("input[type=hidden]").val() , $(this).val(), false);
    });
})
