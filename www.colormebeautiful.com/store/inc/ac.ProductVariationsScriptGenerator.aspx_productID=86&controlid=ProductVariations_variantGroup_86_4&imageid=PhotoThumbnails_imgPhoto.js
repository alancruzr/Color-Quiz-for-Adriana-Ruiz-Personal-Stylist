...
VariantSwatchesProductVariations_variantGroup_86_4 = {
SwatchArray: { 169: {
                        SwatchURL: '/Shared/images/Product/CMB old Single Eyeshadow Small/Amethest-cmb.jpg',
                        ControlPath: 'ProductVariations_variantGroup_86_4'
                    }, 176: {
                        SwatchURL: '/Shared/images/Product/CMB old Single Eyeshadow Small/pewter.jpg',
                        ControlPath: 'ProductVariations_variantGroup_86_4'
                    }, 178: {
                        SwatchURL: '/Shared/images/Product/CMB old Single Eyeshadow Small/sterling.jpg',
                        ControlPath: 'ProductVariations_variantGroup_86_4'
                    }, 182: {
                        SwatchURL: '/Shared/images/Product/CMB old Single Eyeshadow Small/frost-web.jpg',
                        ControlPath: 'ProductVariations_variantGroup_86_4'
                    } },
  ImagingMode: "Resizer",
  ...
  SelectVariant: function(groupID, variantID, setDropDown) {
    ...
    var o = VariantSwatchesProductVariations_variantGroup_86_4.SwatchArray[variantID];
    if (o) {
      if (setDropDown)
...
$(function(){
	...
	$("select[id$='ProductVariations_variantGroup_86_4']").change(function() { VariantSwatchesProductVariations_variantGroup_86_4.SelectVariant( $(this).parent().find("input[type=hidden]").val() , $(this).val(), false) });

    // Bind radio button selection event
    $("input[type=radio][name$='ProductVariations_variantGroup_86_4']").change(function() {
        VariantSwatchesProductVariations_variantGroup_86_4.SelectVariant( $(this).closest('.ProductDetailsVariations').find('.ProductDetailsVariations').find("input[type=hidden]").val() , $(this).val(), false);
    });
})
