...
VariantSwatchesProductVariations_variantGroup_103_4 = {
SwatchArray: { 202: {
                        SwatchURL: '/Shared/images/Product/Brow Pencil Swatches/taupe-pencil.jpg',
                        ControlPath: 'ProductVariations_variantGroup_103_4'
                    }, 201: {
                        SwatchURL: '/Shared/images/Product/Brow Pencil Swatches/Light-brown.jpg',
                        ControlPath: 'ProductVariations_variantGroup_103_4'
                    }, 200: {
                        SwatchURL: '/Shared/images/Product/Brow Pencil Swatches/dark-brown.jpg',
                        ControlPath: 'ProductVariations_variantGroup_103_4'
                    } },
  ImagingMode: "Resizer",
  ...
  SelectVariant: function(groupID, variantID, setDropDown) {
    ...
    var o = VariantSwatchesProductVariations_variantGroup_103_4.SwatchArray[variantID];
    if (o) {
      if (setDropDown)
...
$(function(){
	...
	$("select[id$='ProductVariations_variantGroup_103_4']").change(function() { VariantSwatchesProductVariations_variantGroup_103_4.SelectVariant( $(this).parent().find("input[type=hidden]").val() , $(this).val(), false) });

    // Bind radio button selection event
    $("input[type=radio][name$='ProductVariations_variantGroup_103_4']").change(function() {
        VariantSwatchesProductVariations_variantGroup_103_4.SelectVariant( $(this).closest('.ProductDetailsVariations').find('.ProductDetailsVariations').find("input[type=hidden]").val() , $(this).val(), false);
    });
})
