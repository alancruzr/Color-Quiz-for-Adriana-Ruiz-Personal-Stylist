...
VariantSwatchesProductVariations_variantGroup_37_4 = {
SwatchArray: { 419: {
                        SwatchURL: '/Shared/images/Product/FR Loose Mineral Eyeshadow Swatches/dusky-web.jpg',
                        ControlPath: 'ProductVariations_variantGroup_37_4'
                    }, 62: {
                        SwatchURL: '/Shared/images/Product/FR Loose Mineral Eyeshadow Swatches/shinygold.jpg',
                        ControlPath: 'ProductVariations_variantGroup_37_4'
                    }, 71: {
                        SwatchURL: '/Shared/images/Product/FR Loose Mineral Eyeshadow Swatches/chocolate.jpg',
                        ControlPath: 'ProductVariations_variantGroup_37_4'
                    }, 65: {
                        SwatchURL: '/Shared/images/Product/FR Loose Mineral Eyeshadow Swatches/deepsea.jpg',
                        ControlPath: 'ProductVariations_variantGroup_37_4'
                    }, 67: {
                        SwatchURL: '/Shared/images/Product/FR Loose Mineral Eyeshadow Swatches/purplepink.jpg',
                        ControlPath: 'ProductVariations_variantGroup_37_4'
                    }, 66: {
                        SwatchURL: '/Shared/images/Product/FR Loose Mineral Eyeshadow Swatches/eggplant.jpg',
                        ControlPath: 'ProductVariations_variantGroup_37_4'
                    } },
  ImagingMode: "Resizer",
  ...
  SelectVariant: function(groupID, variantID, setDropDown) {
    ...
    var o = VariantSwatchesProductVariations_variantGroup_37_4.SwatchArray[variantID];
    if (o) {
      if (setDropDown)
...
$(function(){
	...
	$("select[id$='ProductVariations_variantGroup_37_4']").change(function() { VariantSwatchesProductVariations_variantGroup_37_4.SelectVariant( $(this).parent().find("input[type=hidden]").val() , $(this).val(), false) });

    // Bind radio button selection event
    $("input[type=radio][name$='ProductVariations_variantGroup_37_4']").change(function() {
        VariantSwatchesProductVariations_variantGroup_37_4.SelectVariant( $(this).closest('.ProductDetailsVariations').find('.ProductDetailsVariations').find("input[type=hidden]").val() , $(this).val(), false);
    });
})
