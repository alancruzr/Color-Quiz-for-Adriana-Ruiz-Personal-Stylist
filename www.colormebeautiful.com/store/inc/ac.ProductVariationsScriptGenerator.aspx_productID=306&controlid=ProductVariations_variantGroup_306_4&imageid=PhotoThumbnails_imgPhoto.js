...
VariantSwatchesProductVariations_variantGroup_306_4 = {
SwatchArray: { 408: {
                        SwatchURL: '/Shared/images/Product/CMB Color Pro Blush Swatches/soft-rose.jpg.jpeg',
                        ControlPath: 'ProductVariations_variantGroup_306_4'
                    }, 409: {
  ...
  SelectVariant: function(groupID, variantID, setDropDown) {
    ...
    var o = VariantSwatchesProductVariations_variantGroup_306_4.SwatchArray[variantID];
    if (o) {
      if (setDropDown)
...
$(function(){
	...
	$("select[id$='ProductVariations_variantGroup_306_4']").change(function() { VariantSwatchesProductVariations_variantGroup_306_4.SelectVariant( $(this).parent().find("input[type=hidden]").val() , $(this).val(), false) });

    // Bind radio button selection event
    $("input[type=radio][name$='ProductVariations_variantGroup_306_4']").change(function() {
        VariantSwatchesProductVariations_variantGroup_306_4.SelectVariant( $(this).closest('.ProductDetailsVariations').find('.ProductDetailsVariations').find("input[type=hidden]").val() , $(this).val(), false);
    });
})
