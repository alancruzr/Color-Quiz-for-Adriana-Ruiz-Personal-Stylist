...
VariantSwatchesProductVariations_variantGroup_34_4 = {
SwatchArray: { 25: {
                        SwatchURL: '/Shared/images/Product/Mineral Based Lip Shine Swatches/sheer-peach-swatch1.jpg',
                        ControlPath: 'ProductVariations_variantGroup_34_4'
                    }, 24: {
                        SwatchURL: '/Shared/images/Product/Mineral Based Lip Shine Swatches/topazswatch1.jpg',
                        ControlPath: 'ProductVariations_variantGroup_34_4'
                    }, 20: {
                        SwatchURL: '/Shared/images/Product/Mineral Based Lip Shine Swatches/orchidswatch1.jpg',
                        ControlPath: 'ProductVariations_variantGroup_34_4'
                    }, 27: {
                        SwatchURL: '/Shared/images/Product/Mineral Based Lip Shine Swatches/copper-swatch1.jpg',
                        ControlPath: 'ProductVariations_variantGroup_34_4'
                    }, 22: {
                        SwatchURL: '/Shared/images/Product/Mineral Based Lip Shine Swatches/brick-red-swatch1.jpg',
                        ControlPath: 'ProductVariations_variantGroup_34_4'
                    }, 23: {
                        SwatchURL: '/Shared/images/Product/Mineral Based Lip Shine Swatches/plum-berry-swatch1.jpg',
                        ControlPath: 'ProductVariations_variantGroup_34_4'
                    }, 305: {
                        SwatchURL: '/Shared/images/Product/Mineral Based Lip Shine Swatches/cherry-swatch1.jpg',
                        ControlPath: 'ProductVariations_variantGroup_34_4'
                    }, 26: {
                        SwatchURL: '/Shared/images/Product/Mineral Based Lip Shine Swatches/magentaswatch1.jpg',
                        ControlPath: 'ProductVariations_variantGroup_34_4'
                    } },
  ImagingMode: "Resizer",
  ...
  SelectVariant: function(groupID, variantID, setDropDown) {
    ...
    var o = VariantSwatchesProductVariations_variantGroup_34_4.SwatchArray[variantID];
    if (o) {
      if (setDropDown)
...
$(function(){
	...
	$("select[id$='ProductVariations_variantGroup_34_4']").change(function() { VariantSwatchesProductVariations_variantGroup_34_4.SelectVariant( $(this).parent().find("input[type=hidden]").val() , $(this).val(), false) });

    // Bind radio button selection event
    $("input[type=radio][name$='ProductVariations_variantGroup_34_4']").change(function() {
        VariantSwatchesProductVariations_variantGroup_34_4.SelectVariant( $(this).closest('.ProductDetailsVariations').find('.ProductDetailsVariations').find("input[type=hidden]").val() , $(this).val(), false);
    });
})
