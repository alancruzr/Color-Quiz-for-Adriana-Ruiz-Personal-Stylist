...
VariantSwatchesProductVariations_variantGroup_428_16 = {
SwatchArray: { 468: {
                        SwatchURL: '/Shared/images/Product/CMB Color Pro Blush Swatches/all-spice.jpg.jpeg',
                        ControlPath: 'ProductVariations_variantGroup_428_16'
                    }, 467: {
  ...
  SelectVariant: function(groupID, variantID, setDropDown) {
    ...
    var o = VariantSwatchesProductVariations_variantGroup_428_16.SwatchArray[variantID];
    if (o) {
      if (setDropDown)
...
$(function(){
	...
	$("select[id$='ProductVariations_variantGroup_428_16']").change(function() { VariantSwatchesProductVariations_variantGroup_428_16.SelectVariant( $(this).parent().find("input[type=hidden]").val() , $(this).val(), false) });

    // Bind radio button selection event
    $("input[type=radio][name$='ProductVariations_variantGroup_428_16']").change(function() {
        VariantSwatchesProductVariations_variantGroup_428_16.SelectVariant( $(this).closest('.ProductDetailsVariations').find('.ProductDetailsVariations').find("input[type=hidden]").val() , $(this).val(), false);
    });
})
